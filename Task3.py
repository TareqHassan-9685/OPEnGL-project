...
public class assignment_3 implements GLEventListener{
	private GLU glu;
	   @Override
	   public void display(GLAutoDrawable drawable) {
	      final GL2 gl = drawable.getGL().getGL2();
	    
	      MidPointLDA(gl, -10, 20, -15, 00);
	      MidPointLDA(gl, -15, 0, -20, -20);
	      MidPointLDA(gl, -20, 15, -10, 20);
	   
	      MidPointLDA(gl, 0, 20, 20, 20);
	      MidPointLDA(gl, 20, 20, 15, 0);
	      MidPointLDA(gl, 15, 0, 10, -20);
	      MidPointLDA(gl, 0, 20, -5, 0);
	      MidPointLDA(gl, -5, 0, 15, 0);
	   ...
	   public static void main(String[] args) {
	      ...
	      assignment_3 l = new assignment_3();
