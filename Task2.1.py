...
public class Task1 implements GLEventListener{
	private GLU glu;
	   ...
	   public void display(GLAutoDrawable drawable) {
	      ...
	      //for printing 2
	      MidPointLDA(gl, -10, 20, -9, 0);
	      MidPointLDA(gl, -30, 0, -10, 0);
	      MidPointLDA(gl, -30, -20, -31, 0);
	      MidPointLDA(gl, -31, 20, -10, 20);
	      MidPointLDA(gl, -30, -20, -10, -20);
	      // for printing 4
	      MidPointLDA(gl, 0, 0, 20, 20);
	      MidPointLDA(gl, 20, 20, 19, 0);
	      MidPointLDA(gl, 20, 0, 19, -20);
	      MidPointLDA(gl, 0, 0, 20, 0);
